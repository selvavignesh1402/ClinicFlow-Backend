        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                        ...
                        .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/v1/pharmacist/**").hasAnyAuthority("PHARMACIST","CLINICIAN","ADMIN")
                                .requestMatchers("/api/v1/lab/**").hasAnyAuthority("LAB_TECHNICIAN","CLINICIAN","ADMIN")
                                .requestMatchers("/api/v1/finance/invoices/**").hasAnyAuthority("FINANCE_OFFICER","ADMIN")
                                .requestMatchers("/api/v1/manager/**").hasAnyAuthority("CLINIC_MANAGER","ADMIN","FINANCE_OFFICER")
